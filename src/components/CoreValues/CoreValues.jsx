      ...
      <div className="space-y-12">
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          <div className="space-y-2">
            <span className="text-sm font-medium text-primary-200 border border-primary-200 rounded-full px-4 py-1 inline-block">
              Here at Tickrfly
            </span>
            <h3 className="text-4xl font-bold text-primary-200">Our Mission</h3>
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          <div className="space-y-2">
            ...
            <h3 className="text-4xl font-bold text-primary-200">Our Vision</h3>
            <p className="text-gray-50">
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          <div className="space-y-2">
            ...
            <h3 className="text-4xl font-bold text-primary-200">Our Commitment</h3>
            <p className="text-gray-50">
