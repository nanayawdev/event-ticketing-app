  ...
  return (
    <section className="dark:bg-gray-900 py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 min-[375px]:grid-cols-2 min-[650px]:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-x-2 gap-y-4 sm:gap-x-3 sm:gap-y-5 md:gap-x-4 md:gap-y-6 justify-items-center">
