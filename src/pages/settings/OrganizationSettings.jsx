...
import { Building, Mail, Phone, AlertCircle, Camera, MapPin } from 'lucide-react';
        ...
        <div className="flex items-center space-x-6">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">
              High-resolution PNG or JPG recommended. Max size of 2MB.
            </p>
          </div>
        </div>
              ...
              <div>
                ...
                <div className="mt-1 relative">
                  ...
                  <input
                    ...
                    className="block w-full pl-10 rounded-lg border border-gray-300 px-3 py-2
                      focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
                  />
                </div>
              </div>
